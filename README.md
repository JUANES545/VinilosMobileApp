...
## 🍷 APK
A continuación proporcionamos el siguiente [APK](https://github.com/JUANES545/VinilosMobileApp/releases/download/1.0.0/app-debug.apk) para la instalación de la aplicación.
